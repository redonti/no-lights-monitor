...
type Config struct {
	...
	TelegramBotUsername  string // Telegram bot username (without @)
	TelegramChatUsername string // Telegram community chat or forum username (without @)
}
...
func Load() *Config {
	return &Config{
		...
		TelegramChatUsername: getEnv("TELEGRAM_CHAT_USERNAME", ""),
	}
}
